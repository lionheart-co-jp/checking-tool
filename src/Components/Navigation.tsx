...
import {useNavigate, useMatch, Path} from 'react-router-dom'
...
const NavigationItem: React.FunctionComponent<Props> = ({to, children, ...props}) => {
    ...
    return (
        <ListItemButton onClick={handleClick(to)} selected={match !== null} {...props}>{children}</ListItemButton>
    )
}
